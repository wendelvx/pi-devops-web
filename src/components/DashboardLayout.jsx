...
export function DashboardLayout({ children }) {
  return (
    <div className="flex h-screen bg-dark-900 text-slate-200 overflow-hidden font-sans">
      ...
      {/* Sidebar Lateral */}
      <aside className="w-64 glass-card border-r-dark-700 flex flex-col z-10 shrink-0">
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto custom-scrollbar">
          {/* Como a Home já exibe tanto a criação quanto as salas ativas, agrupamos em um único link */}
          <NavItem to="/" icon={<LayoutDashboard size={20} />} label="Painel Geral" />
        </nav>

        {/* REMOVIDO: O Rodapé com o botão de Logout e o link de Configurações saíram daqui */}
      </aside>
      ...
      <main className="flex-1 flex flex-col overflow-hidden relative">
        ...
        {/* Scrollable Content - Aumentei o max-w para aproveitar melhor as telas grandes dos telões */}
